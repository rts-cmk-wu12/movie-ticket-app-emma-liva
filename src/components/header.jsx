...
function Header({ title, navigateReturn = true, toPage = -1, search = false, bookmark = false, bookmarkData }) {
    ...
    return (
        <>
            ...
            <header className="header">
                ...
                {bookmark && <FaRegBookmark color={bookmarked ? '#54a8e5' : '#FFF'} className="header__right" onClick={() => {
                    addToPlans();
                    setBookmarked(true);
                }} />}
            </header>
